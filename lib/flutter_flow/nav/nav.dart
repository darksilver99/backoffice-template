...
class AppStateNotifier extends ChangeNotifier {
  ...
  BackOfficeTamplateAuthUser? initialUser;
  BackOfficeTamplateAuthUser? user;
  ...
  void update(BackOfficeTamplateAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          requireAuth: true,
          builder: (context, params) => const ProductListPageWidget(),
        ),
        FFRoute(
