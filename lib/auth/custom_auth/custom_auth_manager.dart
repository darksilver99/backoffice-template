...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    backOfficeTamplateAuthUserSubject.add(
      BackOfficeTamplateAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<BackOfficeTamplateAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  BackOfficeTamplateAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = BackOfficeTamplateAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    backOfficeTamplateAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
BackOfficeTamplateAuthUser? currentUser;
